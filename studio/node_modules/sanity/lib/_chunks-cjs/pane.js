...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(rxjs.distinctUntilChanged(_temp$p), rxjs.filter(t32), rxjs.map(_temp2$9)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
`, DiffViewPane = React.forwardRef(function(t0, ref) {
  ...
  const compareValue = useCompareValue({
    ...
    data: releases
  } = sanity.useActiveReleases(), [patchChannel] = React.useState(() => sanity.createPatchChannel()), perspective = React.useMemo(() => findRelease(documentId, releases), [documentId, releases]), {
    formState,
    onChange,
    onFocus,
    onBlur,
    ...
    releaseId: sanity.getVersionFromId(documentId),
  ...
  }, [onProgrammaticFocus, pathSyncChannel.path]), isLoading ? /* @__PURE__ */ jsxRuntime.jsx(sanity.LoadingBlock, { showText: !0 }) : /* @__PURE__ */ jsxRuntime.jsx(_singletons.CommentsEnabledContext.Provider, { value: {
    enabled: !1,
    mode: null
...
function useDocumentTitle() {
  const $ = reactCompilerRuntime.c(22), {
    ...
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace), documentValue = isDeleted ? lastRevisionDocument : editState?.version || editState?.draft || editState?.published, subscribed = !!documentValue;
  let t0;
  bb0: {
    if (isDeleted && lastRevisionDocument && schemaType)
      try {
        let t22;
        $[0] !== lastRevisionDocument || $[1] !== schemaType ? (t22 = sanity.prepareForPreview(lastRevisionDocument, schemaType), $[0] = lastRevisionDocument, $[1] = schemaType, $[2] = t22) : t22 = $[2], t0 = t22;
        break bb0;
      } catch (t12) {
  ...
  let t2;
  $[3] !== documentValue || $[4] !== schemaType || $[5] !== t1 ? (t2 = {
    enabled: t1,
    schemaType,
    value: documentValue
  }, $[3] = documentValue, $[4] = schemaType, $[5] = t1, $[6] = t2) : t2 = $[6];
  const {
    error: error_0,
    value
  } = sanity.unstable_useValuePreview(t2);
  ...
  if (!value && !isDeleted) {
    ...
    let t42;
    $[10] !== t || $[11] !== t32 ? (t42 = t("panes.document-header-title.new.text", {
      schemaType: t32
    }), $[10] = t, $[11] = t32, $[12] = t42) : t42 = $[12];
    let t5;
    return $[13] !== t42 ? (t5 = {
      error: void 0,
      title: t42
  ...
  if (error_0) {
    let t32;
    $[15] !== error_0.message || $[16] !== t ? (t32 = t("panes.document-list-pane.error.text", {
      error: error_0.message
    }), $[15] = error_0.message, $[16] = t, $[17] = t32) : t32 = $[17];
    let t42;
    return $[18] !== t32 ? (t42 = {
      error: t32,
      title: void 0
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = sanity.useListFormat(t1), {
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace), telemetry2 = react.useTelemetry(), roleTitles = currentUserRoles.map(_temp$m), roles = listFormat.formatToParts(roleTitles).map(_temp2$7);
  let t2;
  $[1] !== roles ? (t2 = {
...
`, FormHeader = (t0) => {
  ...
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = compareValue, $[43] = connectionState, $[44] = documentId, $[45] = editState?.draft, $[46] = editState?.published, $[47] = fieldActions, $[48] = formState, $[49] = hidden, $[50] = isReadOnly, $[51] = onBlur, $[52] = onChange, $[53] = onFocus, $[54] = onPathOpen, $[55] = onSetActiveFieldGroup, $[56] = onSetCollapsedFieldSet, $[57] = onSetCollapsedPath, $[58] = openPath, $[59] = patchChannel, $[60] = presence, $[61] = selectedPerspective, $[62] = t, $[63] = title, $[64] = validation, $[65] = t13) : t13 = $[65];
  let t14;
  $[66] !== setRef || $[67] !== t12 || $[68] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[66] = setRef, $[67] = t12, $[68] = t13, $[69] = t14) : t14 = $[69];
  let t15;
  $[70] !== margins || $[71] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(sanity.PresenceOverlay, { margins, children: t14 }), $[70] = margins, $[71] = t14, $[72] = t15) : t15 = $[72];
  let t16;
  return $[73] !== hidden || $[74] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[73] = hidden, $[74] = t15, $[75] = t16) : t16 = $[75], t16;
});
...
const FavoriteToggle = (t0) => {
  ...
  let t1;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(DocumentHeaderTitle, {}), $[2] = t1) : t1 = $[2];
  const title = t1;
  let t2;
  $[3] !== showTabs ? (t2 = showTabs && /* @__PURE__ */ jsxRuntime.jsx(DocumentHeaderTabs, {}), $[3] = showTabs, $[4] = t2) : t2 = $[4];
  const tabs = t2;
  let t3;
  $[5] !== BackLink2 || $[6] !== showBackButton || $[7] !== t ? (t3 = showBackButton && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { as: BackLink2, "data-as": "a", icon: icons.ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t("pane-header.back-button.text")
  } }), $[5] = BackLink2, $[6] = showBackButton, $[7] = t, $[8] = t3) : t3 = $[8];
  ...
  let t8;
  $[12] !== activeWorkspace.dataset || $[13] !== activeWorkspace.name || $[14] !== activeWorkspace.projectId || $[15] !== publishedDocId || $[16] !== t4 || $[17] !== t6 || $[18] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(sanity.CapabilityGate, { capability: "comlink", condition: "available", children: /* @__PURE__ */ jsxRuntime.jsx(FavoriteToggle, { resourceType: "studio", documentId: publishedDocId, documentType: t4, resourceId: t6, schemaName: activeWorkspace.name, projectId: activeWorkspace.projectId, dataset: activeWorkspace.dataset, documentExists: t7 }) }), $[12] = activeWorkspace.dataset, $[13] = activeWorkspace.name, $[14] = activeWorkspace.projectId, $[15] = publishedDocId, $[16] = t4, $[17] = t6, $[18] = t7, $[19] = t8) : t8 = $[19];
  const favoriteToggle = t8, t9 = connectionState === "connecting" && !editState?.draft && !editState?.published;
  let t10;
  return $[20] !== backButton || $[21] !== favoriteToggle || $[22] !== t9 || $[23] !== tabIndex || $[24] !== tabs ? (t10 = /* @__PURE__ */ jsxRuntime.jsx(PaneHeader$1, { loading: t9, title, tabs, tabIndex, backButton, appendTitle: favoriteToggle }), $[20] = backButton, $[21] = favoriteToggle, $[22] = t9, $[23] = tabIndex, $[24] = tabs, $[25] = t10) : t10 = $[25], t10;
  ...
  const $ = reactCompilerRuntime.c(104), {
    footerHeight,
    headerHeight,
    isInspectOpen,
    rootElement,
  ...
  bb1: {
    if (params?.historyVersion) {
      let t113;
      $[34] === Symbol.for("react.memo_cache_sentinel") ? (t113 = /* @__PURE__ */ jsxRuntime.jsx(ArchivedReleaseDocumentBanner, {}), $[34] = t113) : t113 = $[34], t10 = t113;
      break bb1;
    }
    let t112;
    $[35] !== selectedPerspective ? (t112 = sanity.isReleaseDocument(selectedPerspective) && sanity.isReleaseScheduledOrScheduling(selectedPerspective), $[35] = selectedPerspective, $[36] = t112) : t112 = $[36];
    const isScheduledRelease = t112, documentInScheduledRelease = !!(isScheduledRelease && displayed?._id && sanity.getVersionFromId(displayed?._id) === selectedReleaseId);
    ...
    if ($[37] !== editState || $[38] !== schemaType || $[39] !== selectedPerspective || $[40] !== workspace.document.drafts.enabled ? (isSelectedPerspectiveWriteable = sanity.isPerspectiveWriteable({
      ...
      let t133;
      $[43] !== isSelectedPerspectiveWriteable.reason || $[44] !== isSelectedPerspectiveWriteable.result || $[45] !== schemaType || $[46] !== selectedPerspective ? (t133 = !isSelectedPerspectiveWriteable.result && /* @__PURE__ */ jsxRuntime.jsx(ChooseNewDocumentDestinationBanner, { schemaType, selectedPerspective, reason: isSelectedPerspectiveWriteable.reason }), $[43] = isSelectedPerspectiveWriteable.reason, $[44] = isSelectedPerspectiveWriteable.result, $[45] = schemaType, $[46] = selectedPerspective, $[47] = t133) : t133 = $[47], t10 = t133;
      break bb1;
    }
    if (documentInScheduledRelease) {
      const t133 = selectedPerspective;
      let t143;
      $[48] !== t133 ? (t143 = /* @__PURE__ */ jsxRuntime.jsx(ScheduledReleaseBanner, { currentRelease: t133 }), $[48] = t133, $[49] = t143) : t143 = $[49], t10 = t143;
      break bb1;
    }
    let t132;
    $[50] !== selectedPerspective ? (t132 = sanity.isSystemBundle(selectedPerspective), $[50] = selectedPerspective, $[51] = t132) : t132 = $[51];
    const isPinnedDraftOrPublish = t132, isCurrentVersionGoingToUnpublish = editState?.version && sanity.isGoingToUnpublish(editState?.version);
    if (displayed?._id && sanity.getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && sanity.isNewDocument(editState) === !1 && !isCurrentVersionGoingToUnpublish) {
      ...
      let t152;
      $[52] !== isScheduledRelease || $[53] !== t143 || $[54] !== value._id ? (t152 = /* @__PURE__ */ jsxRuntime.jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t143, isScheduledRelease }), $[52] = isScheduledRelease, $[53] = t143, $[54] = value._id, $[55] = t152) : t152 = $[55], t10 = t152;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t143;
        $[56] !== displayed || $[57] !== documentId || $[58] !== schemaType ? (t143 = /* @__PURE__ */ jsxRuntime.jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[56] = displayed, $[57] = documentId, $[58] = schemaType, $[59] = t143) : t143 = $[59], t10 = t143;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t143;
        $[60] !== displayed || $[61] !== documentId || $[62] !== schemaType ? (t143 = /* @__PURE__ */ jsxRuntime.jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: !0 }), $[60] = displayed, $[61] = documentId, $[62] = schemaType, $[63] = t143) : t143 = $[63], t10 = t143;
        break bb1;
      }
    }
    ...
    let t142;
    $[64] !== showCreateBanner ? (t142 = showCreateBanner && /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedBanner, {}), $[64] = showCreateBanner, $[65] = t142) : t142 = $[65];
    let t15;
    $[66] !== permissions?.granted || $[67] !== requiredPermission ? (t15 = !permissions?.granted && /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionBanner, { requiredPermission }), $[66] = permissions?.granted, $[67] = requiredPermission, $[68] = t15) : t15 = $[68];
    let t16, t17, t18, t19, t20, t21;
    $[69] === Symbol.for("react.memo_cache_sentinel") ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(RevisionNotFoundBanner, {}), t17 = /* @__PURE__ */ jsxRuntime.jsx(ReferenceChangedBanner, {}), t18 = /* @__PURE__ */ jsxRuntime.jsx(DeprecatedDocumentTypeBanner, {}), t19 = /* @__PURE__ */ jsxRuntime.jsx(CanvasLinkedBanner, {}), t20 = /* @__PURE__ */ jsxRuntime.jsx(DeletedDocumentBanners, {}), t21 = /* @__PURE__ */ jsxRuntime.jsx(UnpublishedDocumentBanner, {}), $[69] = t16, $[70] = t17, $[71] = t18, $[72] = t19, $[73] = t20, $[74] = t21) : (t16 = $[69], t17 = $[70], t18 = $[71], t19 = $[72], t20 = $[73], t21 = $[74]);
    const t22 = displayed?._id ?? documentId;
    let t23;
    $[75] !== isPinnedDraftOrPublish || $[76] !== t22 ? (t23 = /* @__PURE__ */ jsxRuntime.jsx(OpenReleaseToEditBanner, { documentId: t22, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[75] = isPinnedDraftOrPublish, $[76] = t22, $[77] = t23) : t23 = $[77];
    let t24;
    $[78] !== t142 || $[79] !== t15 || $[80] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t142,
      t15,
      t16,
      t17,
      ...
      t21,
      t23
    ] }), $[78] = t142, $[79] = t15, $[80] = t23, $[81] = t24) : t24 = $[81], t10 = t24;
  }
  const banners = t10;
  let t11;
  $[82] !== documentScrollElement ? (t11 = {
    documentScrollElement
  }, $[82] = documentScrollElement, $[83] = t11) : t11 = $[83];
  const portalElements = t11, showFormView = features.resizablePanes || !showInspector;
  let t12;
  $[84] !== activeViewNode || $[85] !== banners || $[86] !== documentScrollElement || $[87] !== footer || $[88] !== formViewHidden || $[89] !== inspectDialog || $[90] !== layoutCollapsed || $[91] !== margins || $[92] !== portalElement || $[93] !== portalElements || $[94] !== showFormView ? (t12 = showFormView && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    ...
    footer
  ] }), $[84] = activeViewNode, $[85] = banners, $[86] = documentScrollElement, $[87] = footer, $[88] = formViewHidden, $[89] = inspectDialog, $[90] = layoutCollapsed, $[91] = margins, $[92] = portalElement, $[93] = portalElements, $[94] = showFormView, $[95] = t12) : t12 = $[95];
  let t13;
  $[96] !== documentId || $[97] !== rootElement || $[98] !== schemaType || $[99] !== showInspector ? (t13 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[96] = documentId, $[97] = rootElement, $[98] = schemaType, $[99] = showInspector, $[100] = t13) : t13 = $[100];
  let t14;
  return $[101] !== t12 || $[102] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t12,
    t13
  ] }) }), $[101] = t12, $[102] = t13, $[103] = t14) : t14 = $[103], t14;
};
...
function ActionMenuListItem(props) {
  ...
  let t5;
  return $[9] !== actionState.icon || $[10] !== actionState.label || $[11] !== actionState.tone || $[12] !== handleClick || $[13] !== hotkeys || $[14] !== t2 || $[15] !== t3 || $[16] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuItem, { "data-testid": t2, disabled: t3, hotkeys, icon: actionState.icon, onClick: handleClick, text: actionState.label, tone: actionState.tone, ...t4 }), $[9] = actionState.icon, $[10] = actionState.label, $[11] = actionState.tone, $[12] = handleClick, $[13] = hotkeys, $[14] = t2, $[15] = t3, $[16] = t4, $[17] = t5) : t5 = $[17], t5;
}
function _temp$j(s) {
...
const DISABLED_REASON_KEY = {
  ...
  const {
    ...
    selectedPerspective
  } = sanity.usePerspective(), isDraft = selectedPerspective === "drafts", handleCancel = React.useCallback(() => {
    setConfirmDialogOpen(!1), onComplete();
...
const DocumentStatusBarActionsInner = React.memo(function(props) {
  ...
  if (!actionProps)
    return null;
  let t3;
  return $[9] !== actionProps || $[10] !== historyActions || $[11] !== renderDocumentStatusBarActions ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actions: historyActions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[9] = actionProps, $[10] = historyActions, $[11] = renderDocumentStatusBarActions, $[12] = t3) : t3 = $[12], t3;
});
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(operators.distinctUntilChanged(), operators.debounceTime(500), operators.switchMap((document2) => isSanityDocument(document2) ? rxjs.from(resolveProductionUrl({
    document: document2
  })) : rxjs.of(void 0)), operators.distinctUntilChanged(), operators.catchError(_temp$c)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], reactRx.useObservable(t3);
}
  ...
  $[38] !== crossDatasetReferences || $[39] !== datasetSubtitle || $[40] !== internalReferences.totalCount || $[41] !== normalizedDatasetNames.length || $[42] !== t || $[43] !== toast ? (t15 = crossDatasetReferences.totalCount > 0 && /* @__PURE__ */ jsxRuntime.jsxs(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { overflow: "auto", paddingTop: 2, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(Table$1, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$7).map((t162, index) => {
          const {
            projectId,
            datasetName,
            documentId
...
function PaneHeaderCreateButton(t0) {
  ...
  const [templatePermissions, isTemplatePermissionsLoading] = sanity.useTemplatePermissions(t2), nothingGranted = !isTemplatePermissionsLoading && templatePermissions?.length !== 0 && templatePermissions?.every(_temp$5);
  let t3;
  bb0: {
...
function EventsTimelineMenu({
  ...
  const selectRev = React.useCallback((revEvent) => {
    ...
    timestamp: new Date(event.timestamp),
    formatParams
  }) : events.length > 0 ? t("timeline.since-version-missing") : t("timeline.no-previous-events"), buttonLabel = mode === "rev" ? revLabel : sinceLabel, portalElements = React.useMemo(() => ({
    [TIMELINE_MENU_PORTAL]: popoverRef
  }), [popoverRef]);
  return /* @__PURE__ */ jsxRuntime.jsx(ui.PortalProvider, { __unstable_elements: portalElements, children: /* @__PURE__ */ jsxRuntime.jsx(Root, { "data-testid": "timeline-menu", constrainSize: !0, content: open && content, "data-ui": "versionMenu", open, placement, matchReferenceWidth: !0, portal: !0, ref: setPopoverRef, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { width: "fill", children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "data-testid": open ? "timeline-menu-close-button" : "timeline-menu-open-button", disabled: loading || !events.length, mode: "ghost", onClick: open ? handleClose : handleOpen, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: {
    maxWidth: "100%"
