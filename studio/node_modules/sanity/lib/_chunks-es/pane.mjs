...
`, DiffViewPane = forwardRef(function(t0, ref) {
  ...
  const compareValue = useCompareValue({
    ...
    data: releases
  } = useActiveReleases(), [patchChannel] = useState(() => createPatchChannel()), perspective = useMemo(() => findRelease(documentId, releases), [documentId, releases]), {
    formState,
    onChange,
    onFocus,
    onBlur,
  ...
  }, [onProgrammaticFocus, pathSyncChannel.path]), isLoading ? /* @__PURE__ */ jsx(LoadingBlock, { showText: !0 }) : /* @__PURE__ */ jsx(CommentsEnabledContext.Provider, { value: {
    enabled: !1,
    mode: null
...
function useDocumentTitle() {
  ...
  bb0: {
    if (isDeleted && lastRevisionDocument && schemaType)
      try {
        let t22;
        $[0] !== lastRevisionDocument || $[1] !== schemaType ? (t22 = prepareForPreview(lastRevisionDocument, schemaType), $[0] = lastRevisionDocument, $[1] = schemaType, $[2] = t22) : t22 = $[2], t0 = t22;
        break bb0;
      } catch (t12) {
...
`, FormHeader = (t0) => {
  ...
  let t14;
  $[66] !== setRef || $[67] !== t12 || $[68] !== t13 ? (t14 = /* @__PURE__ */ jsx(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[66] = setRef, $[67] = t12, $[68] = t13, $[69] = t14) : t14 = $[69];
  let t15;
  $[70] !== margins || $[71] !== t14 ? (t15 = /* @__PURE__ */ jsx(PresenceOverlay, { margins, children: t14 }), $[70] = margins, $[71] = t14, $[72] = t15) : t15 = $[72];
  let t16;
  return $[73] !== hidden || $[74] !== t15 ? (t16 = /* @__PURE__ */ jsx(Container$1, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[73] = hidden, $[74] = t15, $[75] = t16) : t16 = $[75], t16;
});
...
const FavoriteToggle = (t0) => {
  ...
  let t1;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t1 = /* @__PURE__ */ jsx(DocumentHeaderTitle, {}), $[2] = t1) : t1 = $[2];
  const title = t1;
  let t2;
  $[3] !== showTabs ? (t2 = showTabs && /* @__PURE__ */ jsx(DocumentHeaderTabs, {}), $[3] = showTabs, $[4] = t2) : t2 = $[4];
  const tabs = t2;
  let t3;
  $[5] !== BackLink2 || $[6] !== showBackButton || $[7] !== t ? (t3 = showBackButton && /* @__PURE__ */ jsx(Button$1, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
  ...
  let t8;
  $[12] !== activeWorkspace.dataset || $[13] !== activeWorkspace.name || $[14] !== activeWorkspace.projectId || $[15] !== publishedDocId || $[16] !== t4 || $[17] !== t6 || $[18] !== t7 ? (t8 = /* @__PURE__ */ jsx(CapabilityGate, { capability: "comlink", condition: "available", children: /* @__PURE__ */ jsx(FavoriteToggle, { resourceType: "studio", documentId: publishedDocId, documentType: t4, resourceId: t6, schemaName: activeWorkspace.name, projectId: activeWorkspace.projectId, dataset: activeWorkspace.dataset, documentExists: t7 }) }), $[12] = activeWorkspace.dataset, $[13] = activeWorkspace.name, $[14] = activeWorkspace.projectId, $[15] = publishedDocId, $[16] = t4, $[17] = t6, $[18] = t7, $[19] = t8) : t8 = $[19];
  const favoriteToggle = t8, t9 = connectionState === "connecting" && !editState?.draft && !editState?.published;
  let t10;
  return $[20] !== backButton || $[21] !== favoriteToggle || $[22] !== t9 || $[23] !== tabIndex || $[24] !== tabs ? (t10 = /* @__PURE__ */ jsx(PaneHeader$1, { loading: t9, title, tabs, tabIndex, backButton, appendTitle: favoriteToggle }), $[20] = backButton, $[21] = favoriteToggle, $[22] = t9, $[23] = tabIndex, $[24] = tabs, $[25] = t10) : t10 = $[25], t10;
  ...
  bb1: {
    if (params?.historyVersion) {
      let t113;
      $[34] === Symbol.for("react.memo_cache_sentinel") ? (t113 = /* @__PURE__ */ jsx(ArchivedReleaseDocumentBanner, {}), $[34] = t113) : t113 = $[34], t10 = t113;
      break bb1;
    }
    let t112;
    ...
    if (displayed?._id && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === !1 && !isCurrentVersionGoingToUnpublish) {
      ...
      let t152;
      $[52] !== isScheduledRelease || $[53] !== t143 || $[54] !== value._id ? (t152 = /* @__PURE__ */ jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t143, isScheduledRelease }), $[52] = isScheduledRelease, $[53] = t143, $[54] = value._id, $[55] = t152) : t152 = $[55], t10 = t152;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t143;
        $[56] !== displayed || $[57] !== documentId || $[58] !== schemaType ? (t143 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[56] = displayed, $[57] = documentId, $[58] = schemaType, $[59] = t143) : t143 = $[59], t10 = t143;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t143;
        $[60] !== displayed || $[61] !== documentId || $[62] !== schemaType ? (t143 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: !0 }), $[60] = displayed, $[61] = documentId, $[62] = schemaType, $[63] = t143) : t143 = $[63], t10 = t143;
        break bb1;
      }
    }
    ...
    let t142;
    $[64] !== showCreateBanner ? (t142 = showCreateBanner && /* @__PURE__ */ jsx(CreateLinkedBanner, {}), $[64] = showCreateBanner, $[65] = t142) : t142 = $[65];
    let t15;
    $[66] !== permissions?.granted || $[67] !== requiredPermission ? (t15 = !permissions?.granted && /* @__PURE__ */ jsx(InsufficientPermissionBanner, { requiredPermission }), $[66] = permissions?.granted, $[67] = requiredPermission, $[68] = t15) : t15 = $[68];
    let t16, t17, t18, t19, t20, t21;
    $[69] === Symbol.for("react.memo_cache_sentinel") ? (t16 = /* @__PURE__ */ jsx(RevisionNotFoundBanner, {}), t17 = /* @__PURE__ */ jsx(ReferenceChangedBanner, {}), t18 = /* @__PURE__ */ jsx(DeprecatedDocumentTypeBanner, {}), t19 = /* @__PURE__ */ jsx(CanvasLinkedBanner, {}), t20 = /* @__PURE__ */ jsx(DeletedDocumentBanners, {}), t21 = /* @__PURE__ */ jsx(UnpublishedDocumentBanner, {}), $[69] = t16, $[70] = t17, $[71] = t18, $[72] = t19, $[73] = t20, $[74] = t21) : (t16 = $[69], t17 = $[70], t18 = $[71], t19 = $[72], t20 = $[73], t21 = $[74]);
    const t22 = displayed?._id ?? documentId;
    let t23;
    $[75] !== isPinnedDraftOrPublish || $[76] !== t22 ? (t23 = /* @__PURE__ */ jsx(OpenReleaseToEditBanner, { documentId: t22, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[75] = isPinnedDraftOrPublish, $[76] = t22, $[77] = t23) : t23 = $[77];
    let t24;
    $[78] !== t142 || $[79] !== t15 || $[80] !== t23 ? (t24 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t142,
      t15,
      t16,
      t17,
  ...
  let t13;
  $[96] !== documentId || $[97] !== rootElement || $[98] !== schemaType || $[99] !== showInspector ? (t13 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[96] = documentId, $[97] = rootElement, $[98] = schemaType, $[99] = showInspector, $[100] = t13) : t13 = $[100];
  let t14;
  return $[101] !== t12 || $[102] !== t13 ? (t14 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t12,
    t13
...
function ActionMenuListItem(props) {
  ...
  let t5;
  return $[9] !== actionState.icon || $[10] !== actionState.label || $[11] !== actionState.tone || $[12] !== handleClick || $[13] !== hotkeys || $[14] !== t2 || $[15] !== t3 || $[16] !== t4 ? (t5 = /* @__PURE__ */ jsx(MenuItem$1, { "data-testid": t2, disabled: t3, hotkeys, icon: actionState.icon, onClick: handleClick, text: actionState.label, tone: actionState.tone, ...t4 }), $[9] = actionState.icon, $[10] = actionState.label, $[11] = actionState.tone, $[12] = handleClick, $[13] = hotkeys, $[14] = t2, $[15] = t3, $[16] = t4, $[17] = t5) : t5 = $[17], t5;
}
function _temp$j(s) {
...
const DISABLED_REASON_KEY = {
  ...
  const {
    ...
    selectedPerspective
  } = usePerspective(), isDraft = selectedPerspective === "drafts", handleCancel = useCallback(() => {
    setConfirmDialogOpen(!1), onComplete();
...
const DocumentStatusBarActionsInner = memo(function(props) {
  ...
  if (!actionProps)
    return null;
  let t3;
  return $[9] !== actionProps || $[10] !== historyActions || $[11] !== renderDocumentStatusBarActions ? (t3 = /* @__PURE__ */ jsx(RenderActionCollectionState, { actions: historyActions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[9] = actionProps, $[10] = historyActions, $[11] = renderDocumentStatusBarActions, $[12] = t3) : t3 = $[12], t3;
});
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(distinctUntilChanged$1(), debounceTime(500), switchMap((document2) => isSanityDocument(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged$1(), catchError$1(_temp$c)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], useObservable(t3);
}
  ...
  $[38] !== crossDatasetReferences || $[39] !== datasetSubtitle || $[40] !== internalReferences.totalCount || $[41] !== normalizedDatasetNames.length || $[42] !== t || $[43] !== toast ? (t15 = crossDatasetReferences.totalCount > 0 && /* @__PURE__ */ jsxs(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    /* @__PURE__ */ jsxs(Box, { overflow: "auto", paddingTop: 2, children: [
      /* @__PURE__ */ jsxs(Table$1, { children: [
        ...
        /* @__PURE__ */ jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$7).map((t162, index) => {
          const {
            projectId,
            datasetName,
            documentId
...
function PaneHeaderCreateButton(t0) {
  ...
  const [templatePermissions, isTemplatePermissionsLoading] = useTemplatePermissions(t2), nothingGranted = !isTemplatePermissionsLoading && templatePermissions?.length !== 0 && templatePermissions?.every(_temp$5);
  let t3;
  bb0: {
...
function EventsTimelineMenu({
  ...
  const selectRev = useCallback((revEvent) => {
    ...
    timestamp: new Date(event.timestamp),
    formatParams
  }) : events.length > 0 ? t("timeline.since-version-missing") : t("timeline.no-previous-events"), buttonLabel = mode === "rev" ? revLabel : sinceLabel, portalElements = useMemo(() => ({
    [TIMELINE_MENU_PORTAL]: popoverRef
  }), [popoverRef]);
  return /* @__PURE__ */ jsx(PortalProvider, { __unstable_elements: portalElements, children: /* @__PURE__ */ jsx(Root, { "data-testid": "timeline-menu", constrainSize: !0, content: open && content, "data-ui": "versionMenu", open, placement, matchReferenceWidth: !0, portal: !0, ref: setPopoverRef, children: /* @__PURE__ */ jsx(Flex, { width: "fill", children: /* @__PURE__ */ jsx(Button$1, { "data-testid": open ? "timeline-menu-close-button" : "timeline-menu-open-button", disabled: loading || !events.length, mode: "ghost", onClick: open ? handleClose : handleOpen, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: {
    maxWidth: "100%"
